    ...
    <div className="bg-gray-900 rounded-2xl border border-gray-800 overflow-hidden">
      ...
      {collapsed && (
        <div className="px-5 py-3 flex items-center gap-3">
          {isLoading && (
            <div className="flex gap-3 items-center animate-pulse w-full">
              <div className="w-20 h-12 bg-gray-800 rounded-lg flex-shrink-0" />
          ...
          {top && (
            <>
              <div className="relative flex-shrink-0">
                <img src={top.thumbnail} alt={top.title} className="w-20 h-12 rounded-lg object-cover" />
              ...
              <div className="min-w-0">
                <p className="text-white text-xs font-medium line-clamp-1">{top.title}</p>
                <p className="text-gray-500 text-xs mt-0.5 flex items-center gap-2">
                  {top.channel}
                  <span className="flex items-center gap-0.5"><Eye className="w-2.5 h-2.5" />{formatViews(top.views)}</span>
                </p>
              </div>
            </>
          )}
