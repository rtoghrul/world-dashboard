...
import { Newspaper, Bitcoin, Film, Zap, Download, GraduationCap, Plane, Cloud, ShoppingBag, Globe2, Sparkles, TrendingUp, MapPin, Lightbulb } from 'lucide-react'
...
const quickActions = [
  ...
  { icon: Lightbulb, label: { en: 'Facts', az: 'Faktlar', ru: 'Факты', de: 'Fakten' }, href: '/facts', color: 'from-violet-500/20 to-indigo-500/20 border-violet-500/20' },
