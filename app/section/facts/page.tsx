...
export const metadata = {
  ...
  description: 'Explore astronomy, history, human, nature, animals, science, ocean, space, earth, technology, psychology, mysteries, ancient world and weird mind-blowing facts.',
}
      ...
      <main className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-6 w-full">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {factCategories.map(category => (
            <Link
              key={category.id}
              href={`/section/facts/${category.id}`}
